...
const renderArticle = (article) => {
  const {title, date, ...otherProps} = article;// Convert date so simple equality checks work and avoid rerender.
...
const TitleAndSummary = React.memo((props) => {
    ...
    return <React.Fragment>
          ...
          <div className="description"
               dangerouslySetInnerHTML={{__html: summary && sanitizeHtml(summary)}}/>
          </React.Fragment>;
});
